...
public class RingsAdapter extends RecyclerView.Adapter<RingsAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<ProductDetailsModel> mDataList;

    public RingsAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
