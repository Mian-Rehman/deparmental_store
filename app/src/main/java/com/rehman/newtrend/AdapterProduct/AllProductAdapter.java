...
public class AllProductAdapter extends RecyclerView.Adapter<AllProductAdapter.MyViewHolder> {
    ...
    public AllProductAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View myView = LayoutInflater.from(context).inflate(R.layout.all_product_list,parent,false);
