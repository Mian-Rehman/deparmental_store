...
public class HandfreeAdapter extends RecyclerView.Adapter<HandfreeAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<ProductDetailsModel> mDataList;

    public HandfreeAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
