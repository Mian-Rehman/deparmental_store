...
public class WomenFashionAdapter extends RecyclerView.Adapter<WomenFashionAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<ProductDetailsModel> mDataList;

    public WomenFashionAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
