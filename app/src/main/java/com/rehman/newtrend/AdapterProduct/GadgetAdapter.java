...
public class GadgetAdapter extends RecyclerView.Adapter<GadgetAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<ProductDetailsModel> mDataList;

    public GadgetAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
