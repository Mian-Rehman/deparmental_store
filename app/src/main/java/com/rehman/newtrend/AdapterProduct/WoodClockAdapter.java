...
public class WoodClockAdapter extends RecyclerView.Adapter<WoodClockAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<ProductDetailsModel> mDataList;

    public WoodClockAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
