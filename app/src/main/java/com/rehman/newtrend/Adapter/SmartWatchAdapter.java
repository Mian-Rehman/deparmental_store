...
public class SmartWatchAdapter extends RecyclerView.Adapter<SmartWatchAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<ProductDetailsModel> mDataList;

    public SmartWatchAdapter(Context context, ArrayList<ProductDetailsModel> mDataList) {
    ...
    @NonNull
    @Override
    public SmartWatchAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SmartWatchAdapter.MyViewHolder holder, int position) {
