...
public class PaymentInfoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    LinearLayout layout_less,layout_less2,layout_less3,layout_less4,
            layout_more,layout_more2,layout_more3,layout_more4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wallet_button.setOnClickListener(this::onClick);
        ...
        show_more3.setOnClickListener(this::onClick);
        show_less3.setOnClickListener(this::onClick);
        dislike_image3.setOnClickListener(this::onClick);
        like_image3.setOnClickListener(this::onClick);
    }
    ...
    public void onClick(View v)
    {
        ...
        switch (id)
        {
            ...
            case R.id.show_less3:
                layout_less3.setVisibility(View.VISIBLE);
                layout_more3.setVisibility(View.GONE);
                break;

            case R.id.show_more3:
                layout_less3.setVisibility(View.GONE);
                layout_more3.setVisibility(View.VISIBLE);
                break;

            case R.id.like_image3:
            case R.id.dislike_image3:
                feed_text3.setText("Thank you for the feedback");
                like_image3.setVisibility(View.GONE);
                dislike_image3.setVisibility(View.GONE);
                break;
        }
    ...
    private void intiView()
    {
        ...
        layout_less3 = findViewById(R.id.layout_less3);
        show_more3 = findViewById(R.id.show_more3);
        layout_more3 = findViewById(R.id.layout_more3);
        show_less3 = findViewById(R.id.show_less3);
        feed_text3 = findViewById(R.id.feed_text3);
        dislike_image3 = findViewById(R.id.dislike_image3);
        like_image3 = findViewById(R.id.like_image3);
    }
}